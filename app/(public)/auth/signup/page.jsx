  ...
  return (
    <MainPublic>
      <div className="mx-auto w-full max-w-[500px] flex flex-col items-center text-slate-900 bg-white shadow-md shadow-slate-400 rounded-md h-fit px-4 py-6 mb-36">
        ...
        <form onSubmit={handleSubmit} className='flex flex-col w-full px-4 text-base sm:text-lg md:text-xl xl:text-2xl mt-5'>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`bg-blue-600 text-white rounded-full py-2 font-semibold text-lg sm:text-xl md:text-2xl hover:cursor-pointer ${
