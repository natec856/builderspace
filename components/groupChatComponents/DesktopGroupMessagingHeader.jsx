...
export default function DesktopMessagingHeader({ groupName, color, onFocus}) {
  ...
  return (
    <div 
      className="flex items-center w-full py-4 px-10 text-lg sm:text-xl md:text-2xl lg:text-3xl text-slate-900 sticky top-0 z-10 slateBottomShadow rounded-t-md"
