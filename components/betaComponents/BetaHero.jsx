...
export default function BetaHero() {
  return (
    <div className="w-full bg-white">
      {/* HERO */}
      <section className="flex flex-col items-center text-center px-6 py-10 sm:px-10 lg:px-20 bg-white">
        <h1
          className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 max-w-6xl text-slate-900 ${inter.className}`}
        >
        ...
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl leading-snug text-slate-800 max-w-4xl mb-5 font-medium">
