...
export default function FindCooldown() {
  return (
    <div className="flex flex-col items-center text-center">
        <h1 className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-slate-900">Join the Conversation First</h1>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 mt-4 mb-6 px-8">
